...
class EditCandidatesWindow(tk.Toplevel):
    ...
    def remove_candidate(self):
        ...
        if candidate_name:
            CandidatePage.candidates = [c for c in CandidatePage.candidates if c["name"] != candidate_name]
            self.update_candidates()

    def update_candidates(self):
        # Save the updated list of candidates to CSV
        self.save_candidates_to_csv()

        # Update the candidates list in CandidatePage
        candidate_page_instance = self.master.frames[CandidatePage]
        candidate_page_instance.update_candidates()
...
class LoginPageVoter(tk.Toplevel):
    ...
    def login(self):
        ...
        if self.validate(username, password):
            ...
            # Append the username to the candidates.txt file
    ...
    def validate(self, username, password):
    # Assuming the format of the "candidates.txt" file is one username per line
...
class LoginPageAdmin(tk.Toplevel):
    ...
    def validate(self, username, password):
    # Assuming the format of the "candidates.txt" file is "username,password" per line
